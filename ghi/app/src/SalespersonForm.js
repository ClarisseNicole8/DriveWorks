            ...
            <div className="offset-3 col-6">
                <div className="shadow p-4 mt-4">
                    ...
                    <form onSubmit={handleSubmit} id="create-salesperson-form">
                        ...
                        <div className="form-floating mb-3">
                            <input onChange={handleEmployeeIdChange} value={employeeId} placeholder="Employee ID" required type="text" name="femployee_id" id="employee_id" className="form-control" />
